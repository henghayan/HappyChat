                ...
                if isinstance(c, Image.Image):
                    ...
                    if self.config.slice_mode:
                        ...
                        for slice_image in slice_images:
                            ...
                            tgt_sizes.append(
                                torch.Tensor([H // self.config.patch_size, W // self.config.patch_size]).type(
                                    torch.int32))
                    else:
    ...
    def generate_batch(
        ...
        for i in range(len(msgs_batch)):
            ...
            for i, msg in enumerate(copy_msgs):
                ...
                # if i == 0:
                #     assert role == "system", "The role of first msg should be system"
                if isinstance(content, str):
                    content = [content]
